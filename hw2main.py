...
OUTPUT_SIZE = 1  # 不會調整到
# ----------------------------------------------------------------------------------------------------------------------
# 作業, CELL_SIZE and LR, 輸出越複雜 CELL_SIZE 需要越大
# ----------------------------------------------------------------------------------------------------------------------
CELL_SIZE = 150
LR = 0.001
...
def get_batch():
    ...
    # 作業, 改輸出方程式, 改複雜一點
    # ----------------------------------------------------------------------------------------------------------------------
    res = np.cos(xs)**2 * np.sin(xs) + np.cos(xs)**4
...
class LSTMRNN(object):
    ...
    def add_cell(self):
        # ----- replace rnn.BasicLSTMCell with tf.nn.rnn_cell.BasicLSTMCell-----
